...
import edu.osu.settyblue.xreport.MakePhotoActivity;

public class PhotoHandler implements PictureCallback {

    private final Context context;

    public String getFinalNameGlobal() {
        return finalNameGlobal;
    }

    private String finalNameGlobal;
